...
\years{2018 - present}Deep learning research assistant, \textit{Intelligent Robotics Group, NASA Ames Research Center} \\
\years{2018}REU research fellow, \textit{Santa Fe Institute} \\
\years{2017 - present}Biophysics research assistant, \textit{NASA and Department of Mathematics, UC Berkeley} \\
\years{2015 - present}Evolutionary ecology research assistant, \textit{Department of Environmental Science, UC Berkeley}\\
...
\years{2016}Analyst Intern, \textit{EQS Group AG}\\
...
\noindent
\years{2018}\lstinline{deepFlood}: deep learning to track floods using satellite imagery in TensorFlow\\
