...
\years{2015 - present}Evolutionary ecology researcher, \textit{Department of Environmental Science, UC Berkeley}\\

%%\hrule
\section*{Industry $\&$ Nonprofit Experience}
\noindent
\years{2018 - present}Senior Unit-Level Manager, \textit{Berkeley Student Cooperative} \\
...
\noindent
\years{2018}\textbf{Huang EG} (2019) Algorithmic information and inference devices. \emph{\href{https://github.com/eghuang/inferenceDevices/blob/master/inference_devices.pdf}{Manuscript in preparation.}} \\
